...
func TestListMedicationsHandler_WithData(t *testing.T) {
	...
	store.CreateMedication(db, baby.ID, user.ID, "Ursodiol", "50mg", "twice_daily", nil, nil)
	store.CreateMedication(db, baby.ID, user.ID, "VitD", "400IU", "once_daily", nil, nil)
...
func TestUpdateMedLogHandler_InvalidJSON_Boost(t *testing.T) {
	...
	med, _ := store.CreateMedication(db, baby.ID, user.ID, "Test", "10mg", "once_daily", nil, nil)
	givenAt := "2025-07-01T08:00:00Z"
