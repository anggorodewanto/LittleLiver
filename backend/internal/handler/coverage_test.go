...
func TestDashboardHandler_NextDoseAt_ScheduledMedication(t *testing.T) {
	...
	tz := "UTC"
	sched := `["00:01","23:59"]`
	store.CreateMedication(db, baby.ID, user.ID, "TestMed", "10mg", "twice_daily", &sched, &tz, nil, nil)
...
func TestDashboardHandler_NextDoseAt_NoTimezone(t *testing.T) {
	...
	sched := `["08:00","20:00"]`
	store.CreateMedication(db, baby.ID, user.ID, "NoTZMed", "10mg", "twice_daily", &sched, nil, nil, nil)
...
func TestDashboardHandler_NextDoseAt_NoSchedule(t *testing.T) {
	...
	tz := "UTC"
	store.CreateMedication(db, baby.ID, user.ID, "AsNeeded", "5ml", "as_needed", nil, &tz, nil, nil)
...
func TestDashboardHandler_NextDoseAt_AllTimesPassedToday(t *testing.T) {
	...
	tz := "UTC"
	sched := `["00:00","00:01"]`
	store.CreateMedication(db, baby.ID, user.ID, "EarlyMed", "10mg", "twice_daily", &sched, &tz, nil, nil)
...
func TestDashboardHandler_NextDoseAt_InvalidTimezone(t *testing.T) {
	...
	sched := `["08:00"]`
	store.CreateMedication(db, baby.ID, user.ID, "BadTZMed", "10mg", "once_daily", &sched, &invalidTZ, nil, nil)
...
func TestMedicationResponse_EmptyScheduleTimes(t *testing.T) {
	...
	med, err := store.CreateMedication(db, baby.ID, user.ID, "NoSched", "10mg", "as_needed", nil, nil, nil, nil)
	if err != nil {
		t.Fatalf("CreateMedication failed: %v", err)
	}
...
func TestCreateMedLogHandler_BabyIDMismatch(t *testing.T) {
	...
	med, err := store.CreateMedication(db, baby1.ID, user.ID, "VitD", "400IU", "once_daily", nil, nil, nil, nil)
	if err != nil {
		t.Fatalf("CreateMedication: %v", err)
	}
...
func TestCreateMedLogHandler_WithScheduledTime(t *testing.T) {
	...
	med, err := store.CreateMedication(db, baby.ID, user.ID, "UDCA", "50mg", "twice_daily", nil, nil, nil, nil)
	if err != nil {
		t.Fatalf("CreateMedication: %v", err)
	}
