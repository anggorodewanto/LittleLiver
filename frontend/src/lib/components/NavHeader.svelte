		...
		{#if $babies.length > 0}
			...
			<a href="/labs" class="nav-tab" class:active={currentPath === '/labs'}>
				<svg
					...
					stroke-linecap="round"
					stroke-linejoin="round"
					><path d="M9 3h6v7l4 9H5l4-9V3z" /><line x1="9" y1="3" x2="15" y2="3" /></svg
				>
				<span>Labs</span>
			</a>
			...
			<a href="/care-plans" class="nav-tab" class:active={currentPath.startsWith('/care-plans')}>
				<svg
					...
					stroke-linecap="round"
					stroke-linejoin="round"
					><rect x="6" y="4" width="12" height="17" rx="2" /><path d="M9 4h6v3H9z" /><line
						x1="9"
						y1="12"
						x2="15"
						y2="12"
			...
			<a
				href="/immunizations"
				class="nav-tab"
				class:active={currentPath.startsWith('/immunizations')}
			>
				<svg
					width="22"
					height="22"
					...
					><path d="m18 2 4 4" /><path d="m17 7 3-3" /><path
						d="M19 9 8.7 19.3a2.4 2.4 0 0 1-3.4 0l-.6-.6a2.4 2.4 0 0 1 0-3.4L15 5"
